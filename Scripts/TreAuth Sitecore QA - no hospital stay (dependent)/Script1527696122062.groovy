...
WebUI.click(findTestObject('TreAuth Sitecore/Login/div_X'))
...
WebUI.waitForElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/Page_Treatment Authorisation/Page_Treatment Authorisation/TreAuth_menu'), 
    5)

WebUI.click(findTestObject('TreAuth Sitecore/TreaAuth/TreAuth_menu'))
...
WebUI.click(findTestObject('TreAuth Sitecore/TreaAuth/a_navigation-link'))

WebUI.waitForElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/Page_Treatment Authorisation/Page_Treatment Authorisation/h2_About the treatment_update'), 
    5)

WebUI.verifyElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/Page_Treatment Authorisation/Page_Treatment Authorisation/h2_About the treatment_update'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TreAuth Sitecore/TreaAuth/a_navigation-link'))

WebUI.waitForElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/h2_Before you begin...'), 0)

WebUI.verifyElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/h2_Before you begin...'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/Page_Treatment Authorisation/Page_Treatment Authorisation/TreAuth patient second option'))

WebUI.delay(2)

WebUI.scrollToPosition(537, 219)

WebUI.verifyElementAttributeValue(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/Page_Treatment Authorisation/Page_Treatment Authorisation/TreAuth contact home email'), 
    'aria-checked', 'true', 5)
...
WebUI.waitForElementVisible(findTestObject('TreAuth Sitecore/TreaAuth/Page_Treatment Authorisation/li_United Kingdom'), 
    5)
